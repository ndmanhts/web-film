<link href="fonts/font-awesome.min.css" rel="stylesheet" type="text/css">
  ...
  if(Auth::User())  {
    ...
    $idUser=$nguoidung->id;
               ...
               $RightFilm=Film::where('NSX',$film->NSX)->orWhere('author',$film->author)->get()->take(4);
               $idFilm=$film->id;
...
@endif()
   ...
   <b id="CountUnliked">{{$film->unliked}} </b> 
    @else
   <button   style='font-size:24px;border:none;background-color: white' ;
name="like"  ><i class="fa fa-thumbs-up fa-1.5x"></i></button>
<b >{{$film->liked}}</b> 
  <button  
 style='font-size:24px;border:none;background-color: white' ;
   name="Dislike" ><i class="fa fa-thumbs-down fa-1.5x"></i> </button> 
   <b >{{$film->unliked}} </b>
                              ...
                              @if($idUser!=0)
                               <td style="text-align: right" id="LikeComment{{$comment->id}}" > <button  
                                ...
                                <button 
                                 ...
                                 @endif
                                  name="EditComment" class="DislikeComment" id="DislikeComment{{$comment->id}}" DislikeComment="{{$comment->id}}" ><i class="fa fa-thumbs-down " ></i></button></td>
                              @endif
                               @endif
                            </tr>
                            <tr >
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6 col-md-12">
                    <div class="latest-movie">
                      <a >
                        <a style="text-align: center;"><b>{{$film->name}}</b></a>
                                      
                                        <a class="RightFilm" RightFilm="{{$film->id}}"><img src="upload/hinhanh/{{$film->hinhanh}}" alt="Slide 1"></a>
   ...
   $idFilm=<?php echo $idFilm; ?>;
    ...
    $(document).ready(function(){
      $("#XemThemFilm").click(function(){
        $TrangFilm++;
        //aler($TrangFilm);
        $.get("XemThemFilmAjax/"+$TrangFilm+"/"+$idFilm,function(data){
